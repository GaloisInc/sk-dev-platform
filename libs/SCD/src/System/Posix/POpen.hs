...
module System.Posix.POpen (popen) where

import System.Posix(ProcessID, createPipe, forkProcess, closeFd,
  fdToHandle, Fd, dupTo, stdInput, stdOutput, stdError, executeFile)
